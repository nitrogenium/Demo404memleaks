...
up: ## Create and start containers
	...
	$(call print_block, 'PhpMyAdin                        ⇒ http://127.0.0.1:$(PHPMYADMIN_PORT)')
	$(call print_block, 'Additional ports (available for connections) - Redis ⇒ $(REDIS_PORT); MySQL ⇒ $(MYSQL_PORT)')
